...
typewriter.typeString('hey!')
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString("my name is arushi.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i'm a student at ut austin (hook em'!).")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString("i'm also interested in artifical intelligence.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("fan of coffee.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i also like to paint.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
